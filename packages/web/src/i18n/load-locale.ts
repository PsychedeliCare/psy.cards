...
import enUi from "../../../../packages/shared/i18n/ui/en.json";
import frUi from "../../../../packages/shared/i18n/ui/fr.json";
import deUi from "../../../../packages/shared/i18n/ui/de.json";
import itUi from "../../../../packages/shared/i18n/ui/it.json";
...
import enDrugLabels from "../../../../packages/shared/i18n/content/en/drug-labels.json";
import frDrugLabels from "../../../../packages/shared/i18n/content/fr/drug-labels.json";
import deDrugLabels from "../../../../packages/shared/i18n/content/de/drug-labels.json";
import itDrugLabels from "../../../../packages/shared/i18n/content/it/drug-labels.json";

import enComboNotes from "../../../../packages/shared/i18n/content/en/combo-notes.json";
import frComboNotes from "../../../../packages/shared/i18n/content/fr/combo-notes.json";
import deComboNotes from "../../../../packages/shared/i18n/content/de/combo-notes.json";
import itComboNotes from "../../../../packages/shared/i18n/content/it/combo-notes.json";

import enStatusDefs from "../../../../packages/shared/i18n/content/en/status-definitions.json";
import frStatusDefs from "../../../../packages/shared/i18n/content/fr/status-definitions.json";
import deStatusDefs from "../../../../packages/shared/i18n/content/de/status-definitions.json";
import itStatusDefs from "../../../../packages/shared/i18n/content/it/status-definitions.json";

import enClassDesc from "../../../../packages/shared/i18n/content/en/class-descriptions.json";
import frClassDesc from "../../../../packages/shared/i18n/content/fr/class-descriptions.json";
import deClassDesc from "../../../../packages/shared/i18n/content/de/class-descriptions.json";
import itClassDesc from "../../../../packages/shared/i18n/content/it/class-descriptions.json";
...
const drugOverlayModules = import.meta.glob<Record<string, unknown>>(
  "../../../../packages/shared/i18n/content/*/drugs/*.json",
...
function loadDrugOverlays(locale: Locale): Record<string, Record<string, unknown>> {
  const prefix = `../../../../packages/shared/i18n/content/${locale}/drugs/`;
