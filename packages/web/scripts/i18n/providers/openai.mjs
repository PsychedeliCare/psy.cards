...
function buildGlossaryPrompt(locale) {
  const shared = readText("packages/shared/i18n/glossary/README.md");
  const localeGlossary = readText(`packages/shared/i18n/glossary/${locale}.md`);
  const fields = readText("packages/shared/i18n/translatable-fields.md");
